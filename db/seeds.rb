...
Animal.create!(user: talia, animal_type: bird, animal_status: adopt, title: "Birdy", location: "Haifa", gender: "male", description: "Last seen in Haroe 82, very active, was waering a blue collar.")
Animal.create!(user: talia, animal_type: cat, animal_status: adopt, title: "Hello Kitty", location: "Haifa", gender: "male", description: "Last seen in Haroe 82, very active, was waering a blue collar.")
Animal.create!(user: talia, animal_type: dog, animal_status: adopt, title: "Baby", location: "Haifa", gender: "male", description: "Last seen in Haroe 82, very active, was waering a blue collar.")
Animal.create!(user: talia, animal_type: dog, animal_status: adopt, title: "Gucci", location: "Haifa", gender: "male", description: "Last seen in Haroe 82, very active, was waering a blue collar.")
